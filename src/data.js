export const data =[
    {
        ...
        description: "This hotel has rooms and suites with kitchenettes and living room seating areas. The Hotel Beacon is on Manhattan's Upper West Side, 805 m from Central Park. Each room and suite offers free cable on flat-screen TV's, iPod docks and WiFi access. The kitchenettes have a microwave, refrigerator and coffeemaker. Suites at the hotel have a living room with a sofa bed. The quiet and comfortable lobby offers space for visiting or reading and relaxing. There's a business center for  guest use and the hotel offers laundry service and luggage storage. The Hotel Beacon  is 322 m from the American Museum of Natural History, and Lincoln Plaza is 1.1 km away.",
